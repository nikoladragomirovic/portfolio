...
const Socials = () => {
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-row justify-evenly items-center px-10 mt-16 mb-32">
        ...
        <div className="animate__animated animate__zoomInDown animate-delay-[1600ms] flex">
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group p-2 rounded-lg hover:rotate-[23deg] mx-16 duration-300 hover:translate-y-1 bg-indigo-300 bg-opacity-30 outline outline-1 outline-indigo-200"
          >
