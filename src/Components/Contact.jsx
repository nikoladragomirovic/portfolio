    ...
    <>
      ...
      <div className="w-full flex flex-col items-center justify-center mt-[20vh]">
        ...
        <div className="flex w-full flex-row items-center justify-center mt-[2%]">
          <h1 className="text-3xl font-poppins font-bold text-indigo-400 mr-16 animate__animated animate__zoomInDown animate-delay-[1200ms] tracking-wider">
            SOCIALS
          </h1>
          <div className="animate__animated animate__zoomInDown animate-delay-[1400ms] flex flex-row items-center justify-center">
            <Link
          ...
          <div className="animate__animated animate__zoomInDown animate-delay-[1600ms] flex">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group p-2 rounded-lg hover:rotate-[23deg] duration-300 hover:translate-y-1 mx-16 bg-indigo-300 bg-opacity-30 outline outline-1 outline-indigo-200"
            >
