...
const Contact = () => {
  ...
  return (
    <>
      <h1 className="w-full flex items-center justify-center mt-16 mb-20 text-6xl text-indigo-500 font-rubikMaps font-bold animate__animated animate__bounceInDown">
        CONTACT
      </h1>
      <div className="w-full flex flex-col items-center justify-center px-10 pb-10">
        <div className="w-7/12 flex flex-row z-20 items-center justify-center">
          <input
            ...
            className={`w-full py-4 rounded-xl z-30 bg-indigo-50 duration-500 outline px-3 outline-1  placeholder-indigo-300 font-poppins text-indigo-500  ${
              animateSend
                ? "animate__animated animate__bounceOutRight animate-delay-1000"
                : "animate__animated animate__bounceInLeft outline-indigo-500 animate-delay-[600ms]"
            }`}
          ...
          <BiSolidSend
            ...
            className={`text-indigo-500 text-5xl animate__animated mx-5 ${
              animateSend
        ...
        <textarea
          ...
          readOnly={animateSend}
          className={`w-7/12 pb-64 duration-500 rounded-2xl outline z-10 p-3 resize-none outline-1 placeholder-indigo-300  font-poppins text-indigo-500 animate__animated bg-indigo-50 ${
            animateSend
              ? "animate__animated animate__zoomOutUp"
              : "animate__animated animate__zoomInDown animate-delay-[1000ms] outline-indigo-500"
          }`}
        ></textarea>
